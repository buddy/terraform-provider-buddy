    ...
    Steps: []resource.TestStep{
      {
        ...
        Check: resource.ComposeTestCheckFunc(
          ...
          testAccSourceVariablesAttributes("data.buddy_variables.env", 1),
        ),
      },
    },
  })
...
data "buddy_variables" "all" {
   domain = "${buddy_workspace.foo.domain}"
   depends_on = [buddy_variable.a, buddy_variable.b, buddy_variable.aa, buddy_variable.e]
}
